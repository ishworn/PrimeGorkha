...
const Header = () => {
  ...
  // On clicking outside the screen area, close the nav
      ...
      <div className="relative mx-auto max-w-c-1390 items-center justify-between px-4 md:px-8 xl:flex 2xl:px-0">
        <div className="flex w-full items-center justify-between xl:w-1/4">
          ...
          <button
            ...
            onClick={() => setNavigationOpen((prev) => !prev)} // Toggle the state
          >
        ...
        <div
          ...
          className={`invisible h-0 w-full items-center justify-between xl:visible xl:flex xl:h-auto xl:w-full ${
            navigationOpen &&
            "navbar !visible mt-4 h-auto max-h-[400px] rounded-md bg-white p-7.5 shadow-solid-5 lg:bg-transparent xl:h-auto xl:p-0 xl:shadow-none xl:dark:bg-transparent"
          }`}
        >
          <nav>
                ...
                >
                  {menuItem.submenu ? (
                    ...
                    <Link
                      ...
                      onClick={() => setNavigationOpen(false)} // Close the menu when a link is clicked
                    >
                      {menuItem.title}
                    </Link>
                  )}
